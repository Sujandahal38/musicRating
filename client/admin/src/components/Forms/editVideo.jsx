                ...
                <Grid className={classes.Grid} container spacing={3}>
                  <Grid item xs={12} sm={12}>
                    <TextField
                      ...
                      error={!!errors.title}
                      defaultValue={video?.videoDatabyId?.title}
                      helperText={
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      name="artist"
                      label="Artist"
                      defaultValue={video?.videoDatabyId?.artist}
                      fullWidth
                  ...
                  <Grid item xs={12} sm={6}>
                    <Select
                      ...
                      defaultValue={video?.videoDatabyId?.genre}
                      value={genre}
                    >
                  ...
                  <Grid item xs={12} sm={12}>
                    <TextField
                      name="description"
                      defaultValue={video?.videoDatabyId?.description}
